...
def create_dummy_data(db):
    user = User(
        id="ce67983d-151d-49ff-8b06-c9b8bdad085a",
        email="test@test.com",
        name="test user",
        password="1234",
        role="USER"
...
def run_test():
    ...
    try:
        ...
        updated_task = db.query(TaskTracker).filter(TaskTracker.id == task.id).first()
...
# from tasks.embedding_tasks import process_retrieval
...
#     # --------------------------
#     document = Document(
#         id="415e1456-dbbc-4e5e-828b-1ddeed8b986e",
#         user_id=user.id,
#         file_name="test.pdf",
#         storage_path="/tmp/test.pdf",
#         file_size=12345,
